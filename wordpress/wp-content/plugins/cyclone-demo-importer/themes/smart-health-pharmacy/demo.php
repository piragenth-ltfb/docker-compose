...
function cdi_import_files() {
    return array(
        array(
            'import_file_name'             => __('Homepage Smart Health Pharmacy Free','cdi'),
            'categories'                   =>  array( 'Free' , 'Homepage' ),
            'local_import_file'            => CDI_PLUGIN_DIR_PATH . '/themes/smart-health-pharmacy/inc/content.xml',
            'local_import_customizer_file' => CDI_PLUGIN_DIR_PATH . '/themes/smart-health-pharmacy/inc/options.dat',
...
function cdi_after_import_setup( $selected_import ) {
    ...
    switch ( $import_file_name ) {
        ...
        case 'Homepage Smart Health Pharmacy Free':
             $front_page_id = get_page_by_title( 'Smart Health Pharmacy Homepage Free' );
            break;
